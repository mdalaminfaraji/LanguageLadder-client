...
const Navbar = () => {
   ...
   <li><Link to='/classes'>Classes</Link></li>
    ...
    return (
        ...
        {/*<!-- Top bar --> */}
        <div className="border-b border-slate-200 bg-[#C4DFDF]">
          <div className="mx-auto -mt-6 grid w-full max-w-full grid-cols-4 gap-6 py-2 px-6 text-sm text-slate-500 md:grid-cols-8 lg:grid-cols-12">
    ...
    <a className="btn btn-ghost normal-case text-xl">LanguageLadder</a>
  </div>
